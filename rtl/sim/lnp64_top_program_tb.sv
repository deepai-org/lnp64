        ...
        for (trace_tile = 0; trace_tile < TB_CORE_TILE_COUNT; trace_tile = trace_tile + 1) begin
            if (dut.retire_submit_valid_vec[trace_tile]) begin
                ...
                $display(
                    ...
                    dut.retire_submit_record_vec[trace_tile].opcode,
                    dut.retire_submit_record_vec[trace_tile].arch_opcode,
                    ...
                    dut.retire_submit_record_vec[trace_tile].operand_rd,
                    dut.retire_submit_record_vec[trace_tile].operand_rs1,
