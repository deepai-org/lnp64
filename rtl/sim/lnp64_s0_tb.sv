...
module lnp64_s0_tb;
    ...
    initial begin
        ...
        $display(
            "TTRACE {\"record\":\"lnp64_thread_sched_t\",\"pid\":%0d,\"tid\":%0d,\"tile_id\":%0d,\"domain_id\":%0d,\"domain_gen\":%0d,\"state\":%0d,\"latency_class\":%0d,\"wait_generation\":%0d,\"weight_index\":%0d,\"virtual_deadline\":%0d,\"dispatch_eligible\":%0d,\"effective_tile_mask\":%0d,\"migration_generation\":%0d,\"active_location\":%0d}",
            ...
            dut.park_submit_record_vec[0].dispatch_eligible,
            dut.park_submit_record_vec[0].effective_tile_mask,
            dut.park_submit_record_vec[0].migration_generation,
