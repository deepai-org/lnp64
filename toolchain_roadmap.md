...
`toolchain/liblnp64_fd_min.c`, `toolchain/liblnp64_process_min.c`, and
`toolchain/liblnp64_errno_min.c` are the checked source files for those tiny C
shim objects.
