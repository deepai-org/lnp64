...
`demos/netcat.c`, and `demos/httpd.c` to target objects, plus a generated
`natsort` package smoke over `third_party/natsort/strnatcmp.c`. It also covers
