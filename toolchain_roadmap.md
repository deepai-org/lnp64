...
`demos/json_parser.c`, `demos/rot13.c`, and
`demos/producer_consumer.c` to target objects. It also covers
...
allocator, Fibonacci, PCR, cat/openat, JSON parser, rot13, and
producer/consumer smokes now run through real Clang/lld output, while the full
