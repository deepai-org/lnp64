...
libc/runtime is ready. The string/memory simple-libc smoke now links against a
Clang-built tiny C implementation instead of this assembler shim, keeping that
slice on the real C toolchain path.
