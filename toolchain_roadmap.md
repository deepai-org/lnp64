...
`demos/parallel_hash.c`, and `demos/sqlite_lite.c` to target objects. It also covers
...
parallel hash, and sqlite lite smokes now run through real Clang/lld output, while the full
