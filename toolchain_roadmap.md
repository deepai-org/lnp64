...
verifies trivial LNP64 IR codegen, a real Clang compile of scalar C to a target
object, a real Clang assembly compile of `demos/hello.c`, object assembly of
the checked crt0 stub, disassembly of the emitted startup object, and a static
link of crt0 plus an assembler-built `main`.
...
scalar C object compilation, real Clang hello assembly, crt0 assembly,
