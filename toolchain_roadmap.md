...
`toolchain/lnp64_llvm_gates.manifest` and the driver defaults are pinned in
`toolchain/lnp64_clang_driver.manifest`. The Clang compile gates must include
