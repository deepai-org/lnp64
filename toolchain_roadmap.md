...
libc. Those entries are now tested through the real LLVM/lld/software-loader
path. Broader libc/runtime replacement remains partial until the smoke-only
shim is replaced by the production crt/libc runtime.
