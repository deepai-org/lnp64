...
`toolchain/lnp64_clang_driver.manifest`. The implementation file surface is
pinned in `toolchain/lnp64_llvm_filemap.manifest`. The Clang compile gates must
include `toolchain/lnp64_intrinsics.h`, the crt gate must assemble
