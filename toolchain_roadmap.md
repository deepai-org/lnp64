...
`userland/init_clang.c`, `userland/lnpsh_clang.c`, and
`userland/ucat_clang.c` commands under namespace-rooted `run-elf` probes. The
gate assembles the checked
