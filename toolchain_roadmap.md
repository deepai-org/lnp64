...
`demos/hello.c`, `demos/factorial.c`, and `demos/allocator.c` to target
objects, object assembly of the checked crt0 stub, disassembly of emitted
objects, and a static link of crt0 plus an assembler-built `main`.
...
scalar C, hello object, factorial object, and allocator object compilation,
crt0 assembly, disassembly, and static linking through those real tools.
