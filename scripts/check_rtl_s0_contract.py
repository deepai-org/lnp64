...
def main() -> None:
    ...
    for marker in (
        ...
        "SG-SCHED update context missing scheduler metadata",
        "SG-SCHED update context tile drift",
        "SG-SCHED clone bypassed scheduler admission",
        "SG-SCHED clone submit did not match child context",
        ...
        "DOMAIN_OP_ATTACH_SELF",
        "domain_query_memory_used",
        "domain_query_thread_count",
        ...
        "SG-SCHED scheduler submit record missing typed metadata",
        "SG-SCHED scheduler submit record tile drift",
        "SG-SCHED scheduler child state missing typed metadata",
        "SG-SCHED scheduler duplicated runnable TID",
        "SG-SCHED top-level submit record missing typed metadata",
        "SG-SCHED top-level submit record tile drift",
