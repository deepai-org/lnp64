...
"$lnp64_bin" elf-plan target/llvm-lnp64-build/lnp64-sbase-cut-linked.elf \
  >/dev/null
sbase_cut_output="$("$lnp64_bin" run-elf --namespace-root "$sbase_fixture_root" \
  target/llvm-lnp64-build/lnp64-sbase-cut-linked.elf cut -f 2 input/cut.txt)"
...
"$lnp64_bin" elf-plan target/llvm-lnp64-build/lnp64-sbase-sort-linked.elf \
  >/dev/null
sbase_sort_output="$("$lnp64_bin" run-elf --namespace-root "$sbase_fixture_root" \
  target/llvm-lnp64-build/lnp64-sbase-sort-linked.elf sort input/sort.txt)"
