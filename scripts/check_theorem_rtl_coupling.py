...
def check_claim(claim: dict) -> None:
    ...
    check_engine_typed_trace_contract(
        ...
        "vma_memory_safety",
        "m8",
        'TTRACE_M8 {\\"record\\":\\"m8_heap_commit\\"',
        "rtl m8 typed commit trace ok",
    )
    check_engine_typed_trace_contract(
        claim,
        "servicelets_terminate_contained",
        "m9",
        'TTRACE_M9 {\\"record\\":\\"m9_classifier_commit\\"',
        "rtl m9 typed commit trace ok",
    )
    check_engine_typed_trace_contract(
        claim,
        "faults_terminal_progress",
        "m10",
        'TTRACE_M10 {\\"record\\":\\"m10_ras_commit\\"',
        "rtl m10 typed commit trace ok",
    )
    check_engine_typed_trace_contract(
        claim,
        "revocation_generation_safety",
        "m11",
        'TTRACE_M11 {\\"record\\":\\"m11_ddr_commit\\"',
        "rtl m11 typed commit trace ok",
    )
    check_engine_typed_trace_contract(
        claim,
        "domain_containment",
        "m12",
        'TTRACE_M12 {\\"record\\":\\"m12_storage_commit\\"',
        "rtl m12 typed commit trace ok",
    )
    check_engine_typed_trace_contract(
        claim,
        "dma_confined",
        "m13",
        'TTRACE_M13 {\\"record\\":\\"m13_pcie_commit\\"',
        "rtl m13 typed commit trace ok",
    )
    check_engine_typed_trace_contract(
        claim,
        "no_lost_wakeups",
        "m15",
        'TTRACE_M15 {\\"record\\":\\"m15_object_commit\\"',
        "rtl m15 typed commit trace ok",
    )
