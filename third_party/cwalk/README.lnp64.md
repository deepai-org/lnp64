...
small smoke program that exercises Unix path style selection, absolute/relative
predicates, basename/dirname output parameters, segment iteration, and extension
replacement.
