...
mod tests {
  ...
  "$libc_fd_impl_obj" "$libc_errno_impl_obj""#
        ...
        assert!(real_llc.contains("char *strncpy"));
        assert!(real_llc.contains("char *strncat"));
        assert!(real_llc.contains("char *strchr"));
        assert!(real_llc.contains("char *strrchr"));
        assert!(real_llc.contains("char *strstr"));
        assert!(real_llc.contains("size_t strspn"));
        assert!(real_llc.contains("size_t strcspn"));
        assert!(real_llc.contains("char *strpbrk"));
        assert!(real_llc.contains("char *strtok"));
        assert!(real_llc.contains("size_t strlcpy"));
        assert!(real_llc.contains("size_t strlcat"));
        assert!(real_llc.contains("void *memmem"));
