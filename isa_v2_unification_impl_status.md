...
| read_fd/write_fd | 0x2d, 0x57 (static byte-fd) | READ_FD, WRITE_FD                 | 121                     |
| (remaining) | 0x51/0x52 cap_send/cap_recv + 0x2b/0x2c push/pull (need M1 re-coupling, Resolved #5); 0x2e await (poll_min→wait libc + Redis rebuild) | … | → ~117 |
